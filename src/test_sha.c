...
int main(int argc, char *argv[]) {
    ...
    if (!SHA3_224((const uint8_t*)input, len, digest3_224)) {
    ...
    if (!SHA3_256((const uint8_t*)input, len, digest3_256)) {
    ...
    if (!SHA3_384((const uint8_t*)input, len, digest3_384)) {
    ...
    if (!SHA3_512((const uint8_t*)input, len, digest3_512)) {
    ...
    if (!SHAKE128((const uint8_t*)input, len, digest_shake128, shake128_len)) {
    ...
    if (!SHAKE256((const uint8_t*)input, len, digest_shake256, shake256_len)) {
    ...
    if (!RawSHAKE128((const uint8_t*)input, len, digest_rawshake128, rawshake128_len)) {
    ...
    if (!RawSHAKE256((const uint8_t*)input, len, digest_rawshake256, rawshake256_len)) {
